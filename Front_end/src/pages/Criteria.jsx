...
const create = async (data) => {
  try {
    const response = await axios.post("http://localhost:3000/criteria", {
      code: data.code,
      name: data.name,
      bobot: data.bobot,
    });
...
const update = async (id, data) => {
  try {
    const response = await axios.put(`http://localhost:3000/criteria/${id}`, {
      code: data.code,
      name: data.name,
      bobot: data.bobot,
    });
...
const Criteria = () => {
  ...
  const getById = async (id) => {
    try {
      const response = await axios.get(`http://localhost:3000/criteria/${id}`);
      setUbah({
        ...ubah,
        name: response.data.payload.datas.name,
        code: response.data.payload.datas.code,
        bobot: response.data.payload.datas.bobot,
        id: id,
      });
    } catch (error) {
      throw new Error("There was a problem fetching the data:", error);
                  ...
                  <form role="form text-left">
                    ...
                    <div className="input-group mb-3">
                      <input
                        ...
                        value={tambah.bobot}
                        onChange={(e) =>
                          setTambah({ ...tambah, bobot: e.target.value })
                        }
                      />
                    </div>
                  ...
                  <form role="form text-left">
                    ...
                    <div className="input-group mb-3">
                      <input
                        ...
                        value={ubah.bobot}
                        onChange={(e) =>
                          setUbah({ ...ubah, bobot: e.target.value })
                        }
                      />
                    </div>
                    <div className="text-center">
